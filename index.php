...
<head>
    ...
    <title>SILK ROAD ILLEGAL ROAD</title>
...
<body >
 ...
 <div class="navbar navbar-inverse navbar-fixed-top " id="menu">
        <div class="container">
            <div class="navbar-header">
				...
				<a class="navbar-brand">SILK ROAD ILLEGAL ROAD</a>
            </div>
 ...
 <div class="container">
             ...
             <div class="col-lg-12  col-md-12 col-sm-12">
                ...
                <div class="flexslider set-flexi" id="main-section" >
                    <ul class="slides move-me">
                        <!-- Slider 01 -->
                        <li>
                              <h3>High Quality Phones Products</h3>
    ...
    <div  class="tag-line" >
        ...
        <h2 data-scroll-reveal="enter from the bottom after 0.1s" ><i class="fa fa-circle-o-notch"></i> WELCOME TO THE SILK ROAD ILLEGAL ROAD <i class="fa fa-circle-o-notch"></i> </h2>
                   </div>
               </div>
             </div>
                 ...
                 <div class="col-lg-3  col-md-3 col-sm-3" data-scroll-reveal="enter from the bottom after 0.4s">
                  ...
                  <center>  <img class="img img-circle" src="assets/img/person-1.jpg" style="width:100px;height:100px;" />
                   ...
                   <p >
					   ...
					   what we need on our wish. - Nokia developer
                   </p>
				   </center>
                </div>
                   </div>
                  ...
                  <center>  <img class="img img-circle" src="assets/img/person-2.jpg" style="width:100px;height:100px;" />
                   <h3 >Tim <br />Cook</h3>     
                   <p >
                       One time I have mistakenly order a wrong set up but luck they immediately notify me. - Apple CEO
                   </p>
				   </center>
				   <br />
                </div>
                  ...
                  <center>  <img class="img img-circle" src="assets/img/person-3.png" style="width:100px;height:100px;" />
                   ...
                   <p >
                      They are so flexible, approachable they can adjust to my schedule they value trust. - Regular Customer
                   </p>
				   </center>
                </div>
                   </div>
				 ...
				 <div class="col-lg-3  col-md-3 col-sm-3" data-scroll-reveal="enter from the bottom after 0.4s">
                  ...
                  <center>  <img class="img img-circle" src="assets/img/person-4.jpg" style="width:100px;height:100px;" />
                   <h3 >Luan <br />Olivera</h3>
                     <p>They deliver so fast and the price of the items are low. - Online Market Survey</p>
				   </center>
				   <br />
				   <br />
                </div>
...
<div class="container">
           <div class="row" >
                    ...
                    <img class="img img-rounded img-responsive" src="assets/img/phone.png"  style="width:2000px;height:500px;"/>
    ...
    <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1 " data-scroll-reveal="enter from the bottom after 0.4s">
        ...
        <hr />
                    <div >
                        ...
                        <h4><strong>Email: </strong>silkroadillegalroad@gmail.com</h4>
                    </div>
                    </div>
