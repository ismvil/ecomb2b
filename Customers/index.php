...
<body>
    <div id="wrapper">
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">Silk Road Illegal Road Shop</a>
            </div>
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                ...
                <ul class="nav navbar-nav navbar-right navbar-user">
					...
					<li class="dropdown user-dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class='glyphicon glyphicon-shopping-cart'></span> Total Price Ordered: &euro; <?php echo $total; ?> </b></a>
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            ...
            <img src="../assets/img/brandsphone.jpg" alt="Hero Slide" style="width:100%;height:500px;">
        ...
        <div class="item">
            <img src="../assets/img/phone3.png" alt="..." style="width:100%;height:500px;">
		...
		<div class="item">
            <img src="../assets/img/phone3.jpg" alt="..." style="width:100%;height:500px;">
