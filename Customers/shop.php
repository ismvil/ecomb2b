    ...
    <div id="wrapper">
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">SILK ROAD ILLEGAL ROAD </a>
            </div>
         ...
         <center><h3> <span class="glyphicon glyphicon-shopping-cart"></span> This is our phones stocks, Shop now!</h3></center>
        </div>
...
?>
			...
			<div class="alert alert-default" style="background-color:#033c73;">
                       ...
                       &copy 2016 Silk Road Illegal Road | All Rights Reserved |  Design by : SILK ROAD ILLEGAL ROAD Team
