...
include("config.php");
	...
	if($stmt->rowCount() > 0)
	{
		while($row=$stmt->fetch(PDO::FETCH_ASSOC))
		{
			...
			?>
                <tr>
				 ...
				 <td>&euro; <?php echo $order_price; ?> </td>
		...
		echo "<td style='font-size:18px;'><span style='color:red;'>&euro; ".$totalx."</span>";
		echo "</td>";
		...
		echo '<div class="alert alert-default" style="background-color:#033c73;">
                       ...
                       &copy 2016 Silk Road Illegal Road | All Rights Reserved |  Design by : SILK Team
